        ...
        <form className="stickerForm">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="text" name="image" required className="form-control"
            ...
            <fieldset>
                ...
                <label htmlFor="finish_type">FinishType: </label>
                    <select name="finish_type" id="finish" value={currentSticker.finish_type} onChange={changeStickerState} >
                    <option value=""></option>
            ...
            <fieldset>
                ...
                <label htmlFor="sticker_size">Size: </label>
                    <select name="sticker_size" id="size" value={currentSticker.sticker_size} onChange={changeStickerState} >
                    <option value=""></option>
            ...
            <button type="submit"
                onClick={evt => {
                    ...
                    updateSticker(currentSticker,stickerId)
